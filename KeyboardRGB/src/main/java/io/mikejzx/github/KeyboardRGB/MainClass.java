...
import io.mikejzx.github.KeyboardRGB.LEDCtrl.LEDWaveG;
...
{
	public static final String SOFTWARE_VERSION = "0.0.3_01-SNAPSHOT(alpha)";
	...
	public static LEDWaveG ledContWaveG;
	...
	public static enum LEDMode {
		...
		Wave(4, 2, "Wave", true),
		WaveG(8, 3, "WaveGlobal", true),
		Rain(16, 4, "Rain", false), 
		Random(32, 5, "Random", false);
	...
	public void invoke (String[] args) throws IOException, InterruptedException, URISyntaxException {
		...
		ledContWaveG = new LEDWaveG(); ledContWaveG.setColours(cols);
	...
	public static void setLEDMode (LEDMode newMode) {
		...
		switch (ledMode) {
			...
			case WaveG: { ledController = ledContWaveG; } break;
